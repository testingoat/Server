...
export const registerSeller = async (req, reply) => {
    try {
        ...
        const { name, email, storeName, storeAddress, city, pincode, gstNumber, accountNumber, ifscCode, storeContact, storeWebsite } = req.body;
        if (role !== 'Seller') {
        ...
        seller.profileCompleted = !!(seller.name && seller.storeName);
